  ...
  return (
    <div className="pointer-events-none absolute top-0 bottom-0 left-0">
      ...
      {Array.from({ length: level }, (_, index) => {
        ...
        return (
          <div
            className="absolute top-0 bottom-0 border-muted-foreground/20 border-l"
            key={index.toString()}
            style={{
      ...
      <div
        className="absolute top-1/2 border-muted-foreground/20 border-t"
        style={{
      ...
      {isLast && (
        <div
          className="absolute top-0 border-muted-foreground/20 border-l"
          style={{
            left: (level - 1) * (indent ?? 0) + 12,
            height: "50%",
          }}
